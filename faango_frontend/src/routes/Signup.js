...
const SignupComponent = () => {
  ...
  return (
    <div className="">
      <div className="bg-black flex flex-col items-center w-full h-full bg-gradient-to-b from-neutral-900 to-black font-poppins">
        <div className="LogoDiv p-6">
          <img src={faango} alt="faango logo" width={200} />
        </div>
        <div className="InputRegion w-fixed py-1 flex items-center justify-center flex-col bg-black mt-1 rounded-md">
          ...
          <div className="text-white  my-7 text-sm text-zinc-400">
            ...
            <Link
              to="/login"
              className="px-2 underline-offset-1 underline font-bold  hover:text-green-500"
            >
              LOG IN INSTEAD
            </Link>
          </div>
