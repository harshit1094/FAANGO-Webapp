  ...
  return (
    <div>
      <div className="w-full flex h-screen bg-black">
        ...
        <div
          className="flex lg:flex-col justify-between pb-10 rounded-md m-2"
          style={{
            width: div1Width + "px",
        ...
        >
          <div>
            <div className="LogoDiv p-6">
              <img src={faango} alt="FAANGO logo" width={125} />
            </div>
            <div className="py-5">
              <IconText
        ...
        <div
          className="w-1 cursor-col-resize hover:border-r border-solid border-white"
        ...
        <div className="top-0 bg-app-black w-screen m-2 rounded-md overflow-auto">
          <div className="navbar top-0 w-full h-1/10 bg-black bg-opacity-30 flex items-center justify-end z-10">
            <div className="w-1/2 flex h-full">
              ...
              <div className="w-2/5 flex justify-around h-full items-center">
                ...
                />
                <div
                  className="bg-white h-2/3 px-8 flex items-center justify-center rounded-full font-semibold cursor-pointer hover:font-bold transform transition-transform hover:scale-105"
                  onClick={() => {
                    Navigate("/login");
                  }}
                >
          ...
          <div className="content p-8 pt-0 overflow-auto">
            <PlaylistView 
            titleText="MOST LISTENED SONGS" 
            cardsData={focusCardsData} />
            <PlaylistView
              titleText="TOP STREAMED ALBUMS"
              cardsData={FAANGOPlaylistsCardData}
            />
            <PlaylistView
              titleText="PODCASTS"
              cardsData={focusCardsData}
